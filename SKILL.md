...
- Do not let large helper, step, or diagnostic panels stay sticky over the primary mobile content. Before user selection, use lightweight inline hints; after selection, use compact action bars that preserve the main viewing and tapping area.
